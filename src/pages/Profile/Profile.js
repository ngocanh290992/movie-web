  ...
  return (
    <div className='back_NNA'>
      <div className='profile_NNA border_glassmorphism2 flex flex-col'>
        <div class="profile_NNA__img">
          <img src='https://picsum.photos/150' alt='profile_img' />
        </div>

        <div className='profile_NNA__cnt' >
          <div class="profile_NNA__name "><strong>Tài khoản:</strong> {thongTinNguoiDung.taiKhoan}</div>
          <div class="profile_NNA__txt"><strong>Họ tên:</strong> {thongTinNguoiDung.hoTen}</div>
          <div class="profile_NNA__txt"><strong>Email:</strong> {thongTinNguoiDung.email}</div>
          <div class="profile_NNA__txt"><strong>Số điện thoại:</strong> {thongTinNguoiDung.soDT}</div>
        </div>
        <div className='flex justify-center '>
          <button class="profile_NNA__button button_edit" onClick={() => {
            history.push(`/profile/${thongTinNguoiDung.taiKhoan}/edit`)
          }}>Edit</button>
        </div>
