...
import { AppleOutlined, WhatsAppOutlined, TwitterOutlined } from '@ant-design/icons';
            ...
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold text-white">Nguyễn Ngọc Anh</span>
                        </a>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        <p className="pb-1 text-lg font-medium">Home</p>
                        <div className='grid grid-cols-3 gap-2'>
                            {arrHeThongRap.map((rap, index)=>{
                                return <div key={index}>
                                    <img className='w-10 h-10' src={rap.logo} alt={rap.maHeThongRap}/>
                                </div>
                            })}
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        ...
                        <AppleOutlined className='text-3xl mr-5' />

                        <WhatsAppOutlined className='text-2xl mr-5'/>

                        <TwitterOutlined className='text-2xl mr-5'/>
                ...
                <div className="grid justify-center pt-6 lg:justify-between">
                    ...
                    <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                        <a rel="noopener noreferrer" href="#" title="Email" className="flex items-center justify-center w-10 h-10 rounded-full bg-red-600 text-gray-50">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                            </svg>
                        </a>
                        <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full bg-red-600 text-gray-50">
                        ...
                        <a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full bg-red-600 text-gray-50">
